...
class AppComponent {
    constructor(http) {
        this.http = http;
        this.title = 'Likers homepage';
        this.authenticated = false;
        this.credentials = { username: 'xx', password: '123' };
        this.order = {};
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 11, vars: 4, consts: [[2, "text-align", "center", 3, "hidden"], ["type", "button", 1, "btn", "btn-primary", 3, "click"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" Welcome dd to Liker ", ctx.title, "!! ");
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [
        { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HTTP_INTERCEPTORS"], useClass: _app_interceptor__WEBPACK_IMPORTED_MODULE_6__["RefreshInterceptor"], multi: true },
    ], imports: [[
...
module.exports = __webpack_require__(/*! C:\DSWworkspace\2020workspace\SecurityCenterImooc\is-admin\src\main.ts */"./src/main.ts");
